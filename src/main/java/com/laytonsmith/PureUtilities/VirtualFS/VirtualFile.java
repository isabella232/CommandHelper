...
/**
 * A virtual file represents a path to a file in the virtual file system. Not many operations can be done with this
 * class, it is passed instead to the VirtualFileSystem.
 *
 */
